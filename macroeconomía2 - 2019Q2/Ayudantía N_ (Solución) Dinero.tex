...
\textbf{Respuesta:} La función lagrangeano que resolvemos es:
\begin{align*}
...
\end{align*}
Utilizando: $ m_{1}=\dfrac{M_{1}}{P_{1}} $ y $m_{2}=\dfrac{M_{2}}{P_{2}}$ el lagrangeano nos queda así:
\begin{align*}
...
\end{align*}
\item[b.]Demuestre que la demanda de saldos reales para el primer y segundo periodo son $ m_{1}=c_{1}\left[ \dfrac{1+r_{1}}{r_{1}}\right]  $ y $ m_{2}=c_{2} $ respectivamente. Interprete el como reacciona la demanda de saldos en el primer periodo ante un cambio en la tasa de interés nominal.\\

\textbf{Respuesta:} De la ecuación $ (5): \dfrac{\lambda_{1}}{1+\bar{r_{1}}}=\lambda_{2}\beta  $ en la ecuación $ (3):\dfrac{1}{m_{1}}-\lambda_{1}+\dfrac{\lambda_{2}\beta}{\pi_{2}+1}=0 $ podemos obtener lo siguiente:
\begin{align*}
...
De la ecuación $ (4):\dfrac{1}{m_{2}}=\lambda_{2} $ y de $ (2): \lambda_{2}=\dfrac{1}{C_{2}} $ obtenemos:
\begin{align*}
...
\end{center}
Esto nos dice que si el Banco Central aplica una política monetaria contractiva aumentando la tasa de interés, entonces disminuye la demanda de saldos reales del primer periodo como también el consumo presente.
\item[c.]Utilizando $ r=\bar{r}+\pi_{2} $, reescriba la demanda de dinero del primer periodo en función de la tasa de interés real y la tasa de inflación esperada. Cómo reacciona la demanda ante variaciones en la inflación esperada?. Ayuda: suponga que $\beta\left( 1+\bar{r}\right) =1$, y que el Banco Central fija $ M_{1} $ y decide $ M_{2} $. ¿Cómo se ajusta la neutralidad del dinero en el análisis anterior?\\

\textbf{Respuesta:} Reescribiendo la ecuación tenemos que: $ m_{1}=c_{1}\left( \dfrac{1+\bar{r}+\pi_{2}}{\bar{r}+\pi_{2}} \right)  $. Diferenciando la nueva ecuación con respecto a la inflación esperada obtendremos:
\begin{center}
